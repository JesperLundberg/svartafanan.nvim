...
describe("utils", function()
	describe("get_value_fuzzy", function()
		...
		it("should return nil if the value is not in table", function()
			assert.is_nil(sut.get_value_fuzzy(tab, "not_in_table"))
		end)

		it("should return nil if the table is nil", function()
			assert.is_nil(sut.get_value_fuzzy(nil, "not_in_table"))
		end)
	end)
end)
